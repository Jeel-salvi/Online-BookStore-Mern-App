...
const Book = require('./src/books/book.model'); // adjust path as needed
...
mongoose
  .connect("mongodb+srv://zeel4893:Zeelpatel%232006@cluster0.adsykkh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") // or use your .env connection string
  .then(() => {
    console.log('DB connected. Inserting books...');
